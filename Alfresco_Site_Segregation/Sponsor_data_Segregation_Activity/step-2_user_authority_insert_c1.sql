spool step-2_user_authority_insert_c1.log;
set serveroutput on size 1000000;
set define off;
prompt --step-2_user_authority_insert_c1.sql
...
where p.STRING_VALUE='GROUP_site_'||v_sponsor and q.local_name='authorityName');
